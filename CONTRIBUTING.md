...
[Bundler](http://bundler.io/) according to the
...
[Puppet Syntax](https://github.com/gds-operations/puppet-syntax) to check
...
if you're adding new functionality. If you've not used
[rspec-puppet](http://rspec-puppet.com/) before then feel free to ask about how
best to test your new feature. Running the test suite is done with:
